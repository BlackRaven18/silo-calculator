          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text(
                  context.l10n.getLocalizedGrainName(silo.grainName),
                  style: TextStyle(
                    fontSize: 13,
            ...
            _buildInfoRow(
              context,
              'Max:',
              _formatWeight(silo.maxTonnage, context),
              isBold: false,
            ),
            const SizedBox(height: 4),
            _buildInfoRow(
              context,
              '${context.l10n.current_amount} (${(silo.fillLevel * 100).toStringAsFixed(0)}%):',
              _formatWeight(silo.tonnage, context),
              isBold: true,
            ),
